...
/*   Updated: 2023/12/20 18:47:07 by njeanbou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	start_win(t_data *data)
{
	...
	data->wall = mlx_xpm_file_to_image(data->mlx_ptr, "./img/mur.xpm",
			&data->hei, &data->wid);
	data->wall1 = mlx_xpm_file_to_image(data->mlx_ptr, "./img/mur2.xpm",
			&data->hei, &data->wid);
	data->wall2 = mlx_xpm_file_to_image(data->mlx_ptr, "./img/mur3.xpm",
			&data->hei, &data->wid);
